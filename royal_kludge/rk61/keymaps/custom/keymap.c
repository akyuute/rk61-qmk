...
[_BASE] = LAYOUT_all(
    KC_LWIN,     KC_1,     KC_2,     KC_3,     KC_4,     KC_5,     KC_6,     KC_7,     KC_8,     KC_9,     KC_0, KC_MINUS, KC_EQUAL,  KC_BSPC,KC_NO,
    ...
    KC_LCTL,      MO(_VIM),     KC_GUI,     KC_SPC,                                               KC_BSPC,     KC_ALT,     MO(_VIM),    MO(_MEDIA)
),

[_VIM] = LAYOUT_all(
     KC_GRV,    KC_F1,    KC_F2,    KC_F3,    KC_F4,    KC_F5,    KC_F6,    KC_F7,    KC_F8,    KC_F9,   KC_F10,   KC_F11,   KC_F12,  KC_DEL,_______,
    _______,  _______,    KC_UP,  _______,  _______,  _______,  KC_PSCR,  KC_HOME,  KC_PGDN,  KC_PGUP,   KC_END,  _______,  _______,  KC_TAB,
